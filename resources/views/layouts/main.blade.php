...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/AdminLTE-3.2.0/plugins/datatables-buttons/css/buttons.bootstrap4.css') }}">
    @yield('custom_css')
</head>
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('backend/AdminLTE-3.2.0/dist/img/AdminLTELogo.png') }}"
    ...
    <script>
        $(function() {
            $("#example1").DataTable({
                ...
                "searching": false, //o tim kiem
                "ordering": false, // sap xep dong
                ...
                "responsive": false, // nut mo rong khi man hinh bi hep
